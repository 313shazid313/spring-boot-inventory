...
const DepartmentTable = () => {
  const { data, isError, isLoading, refetch } = useReadDepartmentQuery();
...
//   console.log(data);
  ...
  return (
    <div>
      <p className="text-2xl py-4 text-center">Departments</p>
                    ...
                    <td className="px-3 py-3 flex space-x-2">
                      <div className="flex flex-row">
                        <Link
                          ...
                          to={`/dashboard/departments/department-update/${item.id}`}
                        >
